...
public class CommonGetController {
    ...
    @RequestMapping(value = "/course/findByTrainer/{id}")
    ...
    @RequestMapping(value = "/completedtasks/findByCourse/{id}")
    ...
    @RequestMapping(value = "/completedtasks/findByStudent/{id}")
    ...
    @RequestMapping(value = "/completedtasks/findByStudent/{mark}")
    ...
    @RequestMapping(value = "/completedtasks/findByCourse/{id}")
    public ResponseEntity<List<CompletedTask>> getCompletedTasksByBusy(@PathVariable int id) {
        Optional<Course> courseOptional = courseService.findById(id);
        return courseOptional.map(course -> ResponseEntity.ok(completedTaskService.findByCourse(course))).orElseGet(() -> new ResponseEntity<>(HttpStatus.NOT_FOUND));
    }


    @RequestMapping(value = "/completedtasks/{id}", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/trainers/findByFio/{surname}&{firstname}&{secondname}")
    ...
    @RequestMapping(value = "/tasks/findByCourse/{id}")
    ...
    @RequestMapping(value = "/students/findByCourse/{id}")
    ...
    @RequestMapping(value = "/students/findByUser/{username}")
    ...
    @RequestMapping(value = "/students/findByFio/{surname}&{firstname}&{secondname}")
